export default function About() {
  return (
    <section>
      <section>
        <h2 className="lg:text-3xl text-2xl text-center font-semibold text-indigo-400 mb-4">
          Cybersecurity Engineer | Software Developer
        </h2>
        <p className="lg:text-xl text-md text-center italic mb-10">
          {`"Doing my best to achieve my dream - one commit at a time."`}
        </p>
      </section>
      <section className="h-full mx-5">
        <h1 className="lg:text-3xl text-xl text-center font-semibold mb-4">
          About Me 🧑‍💻
        </h1>
